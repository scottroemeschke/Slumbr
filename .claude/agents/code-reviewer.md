---
name: code-reviewer
description: Reviews code for quality, bugs, security, and best practices. Use after code changes or when a second pair of eyes is needed.
...
- Android-specific: memory leaks, context leaks, lifecycle issues
...
- Allocations in hot paths (audio generation loops)
